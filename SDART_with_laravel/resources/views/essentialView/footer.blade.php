<footer >
    <div class="row rowFooter">
        <p class="text-center col-lg">site réalisé par Frank Gerdolle et Thibaut Gerin</p>
...
<!--mes scripts :-->
<!--navbar Fixed TEST-->
<script src="../resources/js/navFixe.js"></script>
<!--navbar Fixed TEST-->
<script src="../resources/js/hideAndShow.js"></script>
<script src="../resources/js/lastLeasonModificator.js"></script>
