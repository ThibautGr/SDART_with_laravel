        ...
        <div class="bgGrey">
            <div class="card ">
                <div class="card-body backGroundColor">
                    <h5 class="card-title"> <img class="imgProfile " src="{{ URL::asset('img/imgIconeUser/'.$ArtbyID->inconLink.'') }} "> <a class="linkArt" href="#">{{$ArtbyID->pseudo}}</a> has published : <a class="linkArt" href="{{url('pageOfArt/'.$ArtbyID->id)}}">{{$ArtbyID->title}}</a></h5>
